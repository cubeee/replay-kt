...
private val rawClassesWithLocation: Array<String> = arrayOf(
...
private val rawClassesWithRotation = arrayOf(
    "TAGame.Ball_Breakout_TA",
    "TAGame.Ball_TA",
    "TAGame.Car_Season_TA",
    "TAGame.Car_TA"
...
fun String.rawObjectClass(): String = when(this) {
...
fun String.rawParentClass(): String = when(this) {
...
fun String.classHasLocation() = this in rawClassesWithLocation
fun String.classHasRotation() = this in rawClassesWithRotation